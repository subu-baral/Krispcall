describe ('Product page', ()=>{
    it ('product page should be visible', ()=>{
        ...
        // items details should be visible
        ...
        // dropdown option Selection and Assertions
        ...
        cy.get('div[data-test="inventory-item-name"]').eq(0).should('contain', 'Sauce Labs Backpack'); 
        cy.get('div[data-test="inventory-item-name"]').eq(3).should('contain', 'Sauce Labs Bolt T-Shirt'); 
